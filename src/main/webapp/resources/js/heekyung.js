...
hee.main = (function(){
		...
		$.getScript(temp,()=>{
			...
			compUI.iBtn('trans')
				...
				.css({'width': '100%', 'height':'40px', 'border': '1px solid', 'text-align': 'center', 'vertical-align': 'middle', 'border-color': '#c4c4c4', 
					'background': 'white', 'font-size': '14px', 'border-radius': '4px', 'cursor': 'pointer', 'font-weight': 'bold', 'line-height': '1.43'})
				.appendTo($transBtn)
				.click(e=>{
					alert('구현되지 않는 기능입니다.');
				});
			...
			.css({'width':'92%', 'height':'50px', 'font-color':'white', 'margin-top':'20px', 'font-size':'22px','font-weight':'bold'})
	...
	var setContextView=function(){
			...
			var layout = '<body style="position: relative;">'
			...
			+'			</div>'
			+'		</div>'
			+'		<div id="location" style="margin: 0 auto; width: 100%; padding-top:40px; padding-bottom: 20px; border-bottom: 1px solid #D5D5D5;">'
			...
			+'	</div>'
			+'	'
			+'	<div id="revBar" style="width:27%; height:400px; display: inline-block; float:right; margin-right:17%; margin-top:-100px; padding-left:3%; z-index:900">'
			+'		<div style="width:100%; height:50px; background-color: #4C4C4C; padding-top: 10px; padding-left: 20px;">'
			...
			+'		</div>'
			+'		<div style="width:100%; height:400px; border: 1px solid; border-color: #c4c4c4; background: white; padding-top: 20px; padding-left: 20px;">'
			+'			<div class="form-group">'
			+'			    <div style="width: 100%">'
			+'			       <div style="width: 45%; display: inline-block;">'
			+'			            <div class="form-group">'
			+'			            	<span style="font-size: 17px; font-weight:bold;">체크인</span>'
			+'							<span class="glyphicon glyphicon-calendar"></span>'
			+'			                <div id="datepicker1" style="width: 100%; padding-top:10px;">'
			+'			                    <input type="text" id="startDt" class="form-control" name="checkin" required="required"/>'
			+'			                </div>'
			+'			            </div>'
			+'			        </div>'
			+'			        <div style="width: 45%; display: inline-block;">'
			+'			            <div class="form-group">'
			+'			            	<span style="font-size: 17px; font-weight:bold;">체크아웃</span>'
			+'			                <span class="glyphicon glyphicon-calendar"></span>'
			+'			                <div id="datepicker2" style="padding-top:10px;">'
			+'			                    <span><input type="text" class="form-control" id="endDt" name="checkout" required="required"/></span>'
			+'			                </div>'
			+'			            </div>'
			+'			        </div>'
			+'			    </div>'
			...
			+'			<div>'
			+'				<div>'
			+'					<span style="font-size: 17px; font-weight:bold;">성인</span>'
			...
			+'					<span style="font-size: 17px; font-weight:bold; ">청소년</span>'
			+'					<select class="form-control" style="width: 92%;">'
			+'					  <option>1</option>'
			+'					  <option>2</option>'
			+'					  <option>3</option>'
			...
			+'				</div>'
			+'				<div style="margin-top:10px;">'
			+'					<span style="font-size: 17px; font-weight:bold;">유아</span>'
			+'					<select class="form-control" style="width: 92%;">'
			+'					  <option>1</option>'
			+'					  <option>2</option>'
			+'					  <option>3</option>'
