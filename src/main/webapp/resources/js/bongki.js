   ...
   var init=function(){
    ...
    var onCreate=function(){
    	$('<div/>',{'id':'container'}).appendTo('body');
          $('#container').append(cho.login());
          $('#email').append(compUI.input('email','text').addClass('cho_input').css({'background-color':'white','placeholder':'이메일'}).attr('placeholder','이메일 주소'));
          $('#pass').append(compUI.input('pass','password').addClass('cho_input').css({'background-color':'white' ,'placeholder':'비밀번호'}).attr('placeholder','비밀번호'));
          
          compUI.btn('facebookBtn').addClass('cho_button').css({'background-color':'#3B5998'})
          .text('페이스북 계정으로 로그인').appendTo('#facebookDiv').click(()=>{
             alert('페이스북');
              $.ajax({
          ...
          compUI.btn('join')
             .addClass('cho_button').attr({'data-toggle':'modal', 'data-target':"#myModal"}).css({'background-color':'#ffb380'}).text('회원가입')
             .appendTo('#join').click(()=>{
             alert('팝업');
             $('body').html(cho.join());
             chobongki.index.init();
          ...
          $('#joinaddBtn').append(compUI.input('addemail','text').addClass('cho_input').css({'background-color':'white'}).attr('placeholder','이메일 주소'));
          $('#joinaddBtn').append(compUI.input('addfirstname','text').addClass('cho_input').css({'background-color':'white'}).attr('placeholder','이름'));
          $('#joinaddBtn').append(compUI.input('addlastname','text').addClass('cho_input').css({'background-color':'white'}).attr('placeholder','성'));
          $('#joinaddBtn').append(compUI.input('addpass','text').addClass('cho_input').css({'background-color':'white'}).attr('placeholder','비밀번호'));
          $('#addjoin').append(compUI.btn('addjoin').addClass('cho_button').css({'background-color':'#ffb380'}).text('회원가입'));
          $('#addlogin').append(compUI.btn('addlogin').addClass('cho_button').css({'background-color':'#ff5a5f'}).text('로그인'));
       
          });
       compUI.btn('login')
             .addClass('cho_button')
             .css({'background-color':'#ff5a5f'})
             .text('로그인')
             .appendTo('#loginDiv')
             .click(()=>{
             alert('123123시작');
            ...
            .addClass('cho_btn')
            .text('숙소예약').appendTo('#profileShow2').click(()=>{
               alert('숙소예약')   
